...
class LeggedRobotCfg(BaseConfig):
    ...
    class domain_rand:
        ...
        recovery_push_interval_s = 6
        recovery_command_hold_s = 3
        recovery_max_time_s = 6
        recovery_stable_time_s = 0.25
        recovery_success_height_ratio = 0.9
        recovery_success_upright = 0.9
        recovery_success_min_contacts = 3
        recovery_init_upside_down_ratio = 0.0
        recovery_push_lin_vel_xy = 1.5
        recovery_push_ang_vel_xy = 4.0
        recovery_push_ang_vel_z = 1.0
        recovery_randomize_orientation_ratio = 0.0
        recovery_randomize_height_range = [0.20, 0.55]
        # Fraction of orientation-randomized recovery events that are sampled
        # close to an explicitly upside-down pose.
        recovery_upside_down_ratio = 0.0
        recovery_upside_down_angle_noise = 0.15
        recovery_upside_down_tilt_noise = 0.15
        recovery_upside_down_velocity_noise = 0.1
        recovery_upside_down_curriculum = False
